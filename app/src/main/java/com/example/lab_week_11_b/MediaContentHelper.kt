...
class MediaContentHelper {
    ...
    // Get the URI for storing images depending on Android version
    ...
    // Get the URI for storing videos depending on Android version
